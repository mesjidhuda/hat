    ...
    if (loading) {
        return (
            ...
            >
                ...
                <div
                    className="summary-card skeleton"
                    style={{ height: 120, borderRadius: 20, marginTop: 15 }}
                />
                <div
                    className="summary-card skeleton"
                    style={{ height: 200, borderRadius: 20, marginTop: 15 }}
                />
            </div>
        );
    }
            ...
            <div style={{ textAlign: "center", marginBottom: 20 }}>
                <div
                    style={{
                        ...
                        borderRadius: "50%",
                        background:
                            "linear-gradient(135deg, rgba(212,175,55,0.3), rgba(212,175,55,0.05))",
                        margin: "0 auto 12px",
                        display: "flex",
                        alignItems: "center",
